...
class AETrainDataset(data_utils.Dataset):
    def __init__(self, user2items, item_count):
        ...
        # Column idices for sparse matrix
        item_col = []
...
class AEEvalDataset(data_utils.Dataset):
    def __init__(self, user2items, item_count):
        ...
        input_list, label_list = self.split_input_label_proprotion(user2items)
    ...
    def split_input_label_proprotion(self, data, label_prop=0.2):
